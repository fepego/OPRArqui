 ...
 */
@Embeddable
public class ColaesperarrentaPK implements Serializable {
    ...
    public ColaesperarrentaPK() {
    }

    public ColaesperarrentaPK(BigInteger idpropietario, BigInteger propiedadIdPropiedad) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ColaesperarrentaPK)) {
            return false;
        }
        ColaesperarrentaPK other = (ColaesperarrentaPK) object;
    ...
    public String toString() {
        return "Entities.ColaesperarrentaPK[ idpropietario=" + idpropietario + ", propiedadIdPropiedad=" + propiedadIdPropiedad + " ]";
    }
